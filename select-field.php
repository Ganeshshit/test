...
// Get fields for the selected domain
$fields = getFieldsByDomain($domainId);

// Get domain name
$conn = getDbConnection();
$stmt = $conn->prepare("SELECT name FROM domains WHERE id = ?");
...
<head>
    ...
    <title>Select Field - Quiz App</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
    <link rel="stylesheet" href="assets/css/select-field.css" />
</head>
<body>
   ...
   <?php include "includes/progress-bar.php" ?>
    ...
    <div class="main-content">
        <div class="container">
            <h1>Select Your Field of Interest</h1>
            <h2>Domain: <?php echo $domain['name']; ?></h2>
            
            <div class="field-selection">
                <?php foreach ($fields as $field): ?>
                    <a href="select-difficulty.php?field_id=<?php echo $field['id']; ?>" class="field-card">
            ...
            <div class="actions">
                <a href="select-domain.php" class="btn-action btn-secondary">
    ...
    updateProgressBar(2); // Start with step 1 active
